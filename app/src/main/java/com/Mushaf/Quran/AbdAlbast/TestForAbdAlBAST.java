...
public class TestForAbdAlBAST extends AppCompatActivity {
    ImageView btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_for_abd_al_bast);
        elasedtimelable =findViewById(R.id.start_musicc);
        btn = findViewById(R.id.plyc);
        seekBar=findViewById(R.id.myseekc);
        reminigtimelable =findViewById(R.id.end_musicc);

        mediaPlayer = new MediaPlayer();
        seekBar.setMax(100);
        Intent intent = getIntent();
        String all = intent.getStringExtra("bast");
        try {
