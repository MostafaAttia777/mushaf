...
public class TestForTablayw extends AppCompatActivity {
    ImageView btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_for_tablayw);

        elasedtimelable =findViewById(R.id.start_musicq);
        btn = findViewById(R.id.plyq);
        seekBar=findViewById(R.id.myseekq);
        reminigtimelable =findViewById(R.id.end_musicq);
        mediaPlayer = new MediaPlayer();
        seekBar.setMax(100);
        Intent intent = getIntent();
        String all = intent.getStringExtra("x");
        try {
