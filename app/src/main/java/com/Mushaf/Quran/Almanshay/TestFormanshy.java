...
public class TestFormanshy extends AppCompatActivity {
    ImageView btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_formanshy);


        elasedtimelable =findViewById(R.id.start_music2);
        btn = findViewById(R.id.ply2);
        seekBar=findViewById(R.id.myseek2);
        reminigtimelable =findViewById(R.id.end_music2);
        mediaPlayer = new MediaPlayer();
        seekBar.setMax(100);
        Intent intent = getIntent();
        String all = intent.getStringExtra("play");
        try {
