...
public class Test_for_khaild extends AppCompatActivity {
    ImageView btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_for_khaild);
        elasedtimelable =findViewById(R.id.start_musicc_tk);
        btn = findViewById(R.id.plyc_tk);
        seekBar=findViewById(R.id.myseekc_tk);
        reminigtimelable =findViewById(R.id.end_musicc_tk);
        mediaPlayer = new MediaPlayer();
        seekBar.setMax(100);
        Intent intent = getIntent();
        String all = intent.getStringExtra("khh");
        try {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mediaPlayer.isPlaying()) {
                    ...
                    Toast.makeText(getBaseContext(), "playinig ♥ ", Toast.LENGTH_SHORT).show();
                    updataseekbar();
                } else {
